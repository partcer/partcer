                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-blue-700">
                                                    Your project will be visible to all freelancers. You'll start receiving proposals once published.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-6">
                                        <label className="flex items-start gap-3">
                                            ...
                                            <span className="text-sm text-gray-600">
                                                I confirm that my project complies with the platform's terms of service and I will provide clear requirements to freelancers.
                                            </span>
                                        </label>
                                    </div>
                                </div>
